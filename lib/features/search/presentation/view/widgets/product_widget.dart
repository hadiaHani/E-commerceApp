...
Widget productWidget(
    ...
    required SearchGController controller1}) {
  Size size = MediaQuery.of(context).size;
  final getCurrProduct = controller1.findByProdId(productId);

  return getCurrProduct == null
      ? const SizedBox.shrink()
      : GetBuilder<SearchGController>(builder: (controllerds) {
              ...
              child: InkWell(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsets.symmetric(horizontal: ManagerWidth.w04),
                      child: Row(
